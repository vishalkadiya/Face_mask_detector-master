...
def model_init(path):
	path = rf"C:\Users\visha\Desktop\Face_mask_detector-master\{model_path}"
	print(path)
...
def get_output(interpreter,output_details,i_detail,cam,shape):  #
	...
	while not done:
		...
		print(i_detail[0]['index'], output_frame)
...
def draw_and_show(box,classes,scores,num,frame): # Face Detection mate box create kre che
